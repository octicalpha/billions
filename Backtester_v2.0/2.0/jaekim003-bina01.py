...
class AlphaMain:
    def __init__(self, startdate, enddate, booksize, download, altsim_dir,pnl_dir):
        ...
        self.set_exch = ['KRKN']
        self.set_base = ['BTC','XRP','ETH','ETC','BCH'] #['BTC','XRP','ETH','XVG','BCH','LTC','NEO','ADA','OMG','ETC','ZEC','BTG','NXT','XMR','DASH'] # avoid using unless data is scarse 
    ...
    def generate(self):
        ...
        for col in self.alpha:
            z = self.z_score_ret(col,1,36,288*5,'close')
