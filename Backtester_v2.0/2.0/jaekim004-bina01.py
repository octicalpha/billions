...
class AlphaMain:
    def __init__(self, startdate, enddate, booksize, download, altsim_dir,pnl_dir):
        ...
        self.set_short_case = [] #['BTC-USD-KRKN','ETH-USD-KRKN','ETC-USD-KRKN','BCH-USD-KRKN','XRP-USD-KRKN','ZEC-USD-KRKN','XMR-USD-KRKN'] #['BTC-USD-KRKN','ETH-USD-KRKN','ETC-USD-KRKN','BCH-USD-KRKN','LTC-USD-KRKN','XRP-USD-KRKN','XMR-USD-KRKN']
        self.set_quote = ['BTC']
