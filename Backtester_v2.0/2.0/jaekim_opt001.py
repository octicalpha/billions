...
class AlphaMain:
    def __init__(self, startdate, enddate, booksize, download, altsim_dir,pnl_dir):
        ...
        self.opt_alphas_pnl = ['/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim001_pnl.csv'
                        ,'/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim002_pnl.csv'
                        ,'/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim003_pnl.csv'
                        #,'/home/ubuntu/AltSim/2.0/pnl/alphatest02_pnl.csv'
                        ,'/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim004_pnl.csv']
        self.opt_alphas_pos = ['/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim001_pos.csv'
                        ,'/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim002_pos.csv'
                        ,'/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim003_pos.csv'
                        #,'/home/ubuntu/AltSim/2.0/pnl/alphatest02_pos.csv'
                        ,'/home/ubuntu/AltSim-Execution/2.0/pnl/jaekim004_pos.csv']
        self.opt_rebalance = ['00:00:00']
        self.opt_backdays = 1440
    ...
    def initializes(self):
        ...
        """
        # Universe
        UH = UniHandler(self.startdate,self.enddate,self.download,self.altsim_dir)
    ...
    def operations(self,alpha_raw):
        ...
        output = apply_exch_booksize_trunc(output,'BTRX','KRKN',0.5,self.booksize)
        output = self.hump_size(output,10)
